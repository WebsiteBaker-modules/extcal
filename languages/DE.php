...
$LANG['backend'] = array(
    'TXT_EXTCAL_SETTINGS'           => "Einstellungen f&uuml;r die externen Kalender -"
                                     . " geben Sie {DEFAULT} ein, um ein beliebiges"
                                     . " Feld auf seinen Standardwert"
                                     . " zur&uuml;ckzusetzen",
    'TXT_EXTCAL_SETTINGS_URLS'      => "URLs der externen Kalender hier eintragen,"
                                     . " jede URL auf einer separaten Zeile",
    'TXT_EXTCAL_MAX_DAYS'           => "zeige so viele Tage im Voraus"
                                     . " (0 = keine Beschr&auml;nkung)",
    'TXT_EXTCAL_MAX_ENTRIES'        => "zeige maximal so viele Eintr&auml;ge"
                                     . " (0 = keine Beschr&auml;nkung)",
    'TXT_EXTCAL_TIME_ZONE'          => "Zeitzone zur Anzeige der Kalendereintr&auml;ge"
                                     . " (leer = default-Zeitzone)",
    'TXT_EXTCAL_DATEFORMAT'         => "das Datumsformat (ohne Uhrzeit)",
    'TXT_EXTCAL_TIMEFORMAT'         => "das Zeitformat  (sofern es sich nicht um einen"
                                     . " ganzt&auml;gigen Termin handelt)",
    'TXT_EXTCAL_DATE_SEPARATOR'     => "Trenner zwischen Anfangs- und Enddatum",
    'TXT_EXTCAL_SECTION_START'      => "Formatierung am Anfang der gesamten Section"
                                     . " (z.B. auch eine &Uuml;berschrift)",
    'TXT_EXTCAL_DATE_END'           => "Formatierung am Ende des Datums"
                                     . " (wird an {DATE} angeh&auml;ngt)",
    'TXT_EXTCAL_SECTION_END'        => "Formatierung am Ende der gesamten Section",
    'TXT_EXTCAL_CACHE_SIZE'         => "aktuell f&uuml;r CalDAV Eintr&auml;ge"
                                     . " verwendeter Cache",
    'TXT_EXTCAL_EMPTY_CACHE'        => "Cache leeren",
    'TXT_EXTCAL_ENABLE_CACHE'       => "Cache aktivieren",
    'TXT_EXTCAL_REFRESH_TIME'       => "Aktualisierungs-Cache-Zeit zwischen zwei"
                                     . " Seitenaufrufen in Sekunden",
    'TXT_EXTCAL_CACHE_TIME'         => "Cache-Zeit f&uuml;r Langzeit-Speicherung der"
                                     . " Kalendereintr&auml;ge in Tagen",
    'TXT_EXTCAL_DESCRIPTION_END'    => "Formatierung um die ausf&uuml;hrliche"
    ...
    'TXT_EXTCAL_ENTRY_TEMPLATE'     => "im folgenden Template k&ouml;nnen Sie das"
                                     ...
                                     . " Die oben definierten Formatierungsbausteine zum"
                                     . " Einleiten und Abschlie&szlig;en der jeweiligen"
                                     . " Platzhalter werden um diese herum"
                                     . " eingef&uuml;gt falls der jeweilige String im"
                                     . " aktuellen Kalendereintrag nicht leer ist.",
    'TXT_EXTCAL_DESCRIPTION_START'  => "Formatierung um die ausf&uuml;hrliche"
                                     . " Beschreibung einzuleiten (wird {DESCRIPTION}"
                                     . " vorangestellt)",
    'TXT_EXTCAL_LOCATION_START'     => "Formatierung um den Ort einzuleiten"
                                     . " (wird {LOCATION} vorangestellt)",
    'TXT_EXTCAL_LOCATION_END'       => "Formatierung um den Ort abzuschlie&szlig;en"
                                     . " (wird an  {LOCATION} angeh&auml;ngt)",
    'TXT_EXTCAL_TITLE_START'        => "Formatierung um den Titel einzuleiten"
                                     . " (wird  {TITLE} vorangestellt)",
    'TXT_EXTCAL_TITLE_END'          => "Formatierung um den Titel abzuschlie&szlig;en"
                                     . " (wird an  {TITLE} angeh&auml;ngt)",
    'TXT_EXTCAL_DATE_START'         => "Formatierung um das Datum einzuleiten"
                                     . " (wird  {DATE} vorangestellt)",
    'TXT_EXTCAL_CONFIDENTIAL_TEXT'  => "Text der anstelle des Titels bei vertraulichen"
                                     . " Terminen angezeigt wird (inclusive den"
                                     . " einleitenden und abschlie&szlig;enden Tags"
                                     . " falls Sie diesen Text davon eingeschlossen"
                                     . " haben m&ouml;chten)",
    'TXT_EXTCAL_DATE_TEMPLATE'      => "Mit dem folgenden Template k&ouml;nnen Sie das"
                                     . " Erscheinungsbild des Datums fein-justieren."
                                     . " M&ouml;gliche Platzhalter sind {START_DATE},"
                                     . " {END_DATE}, {START_TIME}, {END_TIME} und"
                                     . " {DATE_SEPARATOR}. Letzteres und der einleitende"
                                     . " und der abschlie&szlig;ende Formatierungsblock,"
                                     . " die das Ergebnis nach Anwendung dieses"
                                     . " Templates einschlie&szlig;en, werden weiter"
                                     . " oben definiert.",
    'TXT_EXTCAL_OPTIMIZE_DATE'      => "versuche die Ausgabe des Datums zu optimieren"
                                     . " (z.B. das Enddatum weglassen, wenn es am"
                                     . " gleichen Tag wie der Anfang des Termins ist)",
    'TXT_EXTCAL_MIDNIGHT_FIX'       => "quetsche Termine, die um Mitternacht enden noch"
                                     . " in den Vortag",
    'TXT_EXTCAL_VERIFY_PEER'        => "&Uuml;berpr&uuml;fe ssl-Zertifikate f&uuml;r"
                                     . " https-Verbindungen (Sicherheitsrisiko wenn"
                                     . " deaktiviert)",

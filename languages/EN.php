...
$LANG['backend'] = array(
    'TXT_EXTCAL_SETTINGS'           => "Settings for the external calendar"
                                     . " - enter {DEFAULT} to reset any field"
                                     . " to its default value",
    'TXT_EXTCAL_SETTINGS_URLS'      => "Enter the URLs of your calendars to display "
                                     . "here, one line per URL",
    ...
    'TXT_EXTCAL_TIME_ZONE'          => "time zone to display entries "
                                     . "(empty = default time zone)",
    'TXT_EXTCAL_DATEFORMAT'         => "the date format (without time)",
    'TXT_EXTCAL_TIMEFORMAT'         => "the time format"
                                     . " (unless it's an allday-appointment)",
    'TXT_EXTCAL_DATE_SEPARATOR'     => "the separator used between start"
                                     . " and end date or time",
    'TXT_EXTCAL_SECTION_START'      => "formatting for the beginning"
                                     . " of the whole section (e.g. headline)",
    'TXT_EXTCAL_DATE_END'           => "formatting at the end of the date "
                                     . "(appended to {DATE})",
    ...
    'TXT_EXTCAL_REFRESH_TIME'       => "Refresh time for the whole calendars "
                                     . "between a few calls of the site in seconds",
    'TXT_EXTCAL_CACHE_TIME'         => "Cache time for calendar entries"
                                     . " which are not modified in days",
    ...
    'TXT_EXTCAL_DESCRIPTION_START'  => "formatting of the beginning of the description"
                                     . " (prepended to {DESCRIPTION})",
    'TXT_EXTCAL_LOCATION_START'     => "formatting at the beginning of a location"
                                     . " (prepended to {LOCATION})",
    'TXT_EXTCAL_LOCATION_END'       => "formatting at the end of a location"
                                     . " (appended to {LOCATION})",
    'TXT_EXTCAL_TITLE_START'        => "formatting at the beginning of a title"
                                     . " (prepended to {TITLE})",
    'TXT_EXTCAL_TITLE_END'          => "formatting at the end of a title"
                                     . " (appended to {TITLE})",
    'TXT_EXTCAL_DATE_START'         => "formatting at the beginning of the date"
                                     . " (prepended to {DATE})",
    'TXT_EXTCAL_CONFIDENTIAL_TEXT'  => "text displayed as description for confidential"
                                     . " entries (including the opening and closing"
                                     . " tags if you would like to have those around"
                                     . " that text)",
    'TXT_EXTCAL_DATE_TEMPLATE'      => "in the following template you can fine-tune the"
                                     . " appearance of the date. Possible place holders"
                                     . " are {START_DATE}, {END_DATE}, {START_TIME},"
                                     . " {END_TIME}, and {DATE_SEPARATOR}."
                                     . " The latter and the opening and closing blocks,"
                                     . " are wrapped around the result of this template,"
                                     . " are defined above.",
    'TXT_EXTCAL_OPTIMIZE_DATE'      => "try to optimize the date output"
                                     . " (e.g. drop end date if it is on the same day)",
    'TXT_EXTCAL_MIDNIGHT_FIX'       => "squeeze appointments ending at midnight into the"
                                     . " day before",
    'TXT_EXTCAL_VERIFY_PEER'        => "verify ssl-certificates for https-connections"
